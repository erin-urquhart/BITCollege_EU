...
namespace BITCollege_EU.Controllers
{
    public class AcademicProgramsController : Controller
    {
        ...
        {
            AcademicProgram academicProgram = db.AcademicPrograms.Find(id);
            //Clears the relationship between the AcademicProgram object and corresponding Student record
            academicProgram.Student.Clear();
            //Clears the relationship between the AcademicProgram object and corresponding Course record
